"""
Django settings for guitar_configurator project.
...
ROOT_URLCONF = 'guitar_configurator.urls'
...
WSGI_APPLICATION = 'guitar_configurator.wsgi.application'
...
MEDIA_ROOT = BASE_DIR / 'static-root/'
